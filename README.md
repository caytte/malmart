...
思いつくままに機能追加をし、実装してきたので、重複や今となっては不要な処理が含まれているような気がします。また、アップも雑にしているので、要微調整です(笑)。
今回gitに入れましたが、利用者にはある程度中身を読んで理解してもらう必要があります。
信頼のある研究室内のシステムという事でセキュリティ面はあえて一切考慮していません。データベースくらいはしっかりしても良いかなと思います。
...
* **キャッシュレス決済:** 学生証(FeliCa)をカードリーダーにかざすだけで、簡単かつ迅速に支払いが完了します。
...
Restricted to use within our laboratory only.
* **Copyright**: © Ito Keito. All Rights Reserved.
